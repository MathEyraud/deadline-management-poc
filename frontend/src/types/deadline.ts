 ...
 * Définit toutes les interfaces et types liés aux échéances
 * @module types/deadline
 */
 ...
 */
export type CreateDeadlineDto = Omit<Deadline, 'id' | 'createdAt' | 'comments' | 'attachments' | 'creator'>;
